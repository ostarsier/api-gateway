...
public class Test {
    public static void main(String[] args) throws Exception {
        ...
        //1、获取token
        String getToken = "http://localhost:80/oauth/token?grant_type=password&username=root&password=123456&client_id=weixin&client_secret=123456";
        ...
        //2、访问url
        String resource = "http://localhost:80/api/test";
